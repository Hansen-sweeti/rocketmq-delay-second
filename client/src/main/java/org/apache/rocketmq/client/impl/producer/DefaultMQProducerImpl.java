...
public class DefaultMQProducerImpl implements MQProducerInner {
    ...
    private TopicPublishInfo tryToFindTopicPublishInfo(final String topic) {
        ...
        if (null == topicPublishInfo || !topicPublishInfo.ok()) {
            ...
            //向namesrv更新topic
            //根据topicroutedata转化为topicPublishInfo
        ...
        if (topicPublishInfo.isHaveTopicRouterInfo() || topicPublishInfo.ok()) {
            ...
            //Nameserver拉取default topic：如果本地没有，则去NameServer去拉取对应Topic信息
            //default是默认broker都有的topic
    ...
    private SendResult sendKernelImpl(final Message msg,
        ...
        if (brokerAddr != null) {
            ...
            try {
                ...
                //producer投递消息到broker：将消息内容及其他信息封装进请求头
                SendMessageRequestHeader requestHeader = new SendMessageRequestHeader();
                requestHeader.setProducerGroup(this.defaultMQProducer.getProducerGroup());
                requestHeader.setTopic(msg.getTopic());
                requestHeader.setDefaultTopic(this.defaultMQProducer.getCreateTopicKey());
                requestHeader.setDefaultTopicQueueNums(this.defaultMQProducer.getDefaultTopicQueueNums());
                //producer投递消息到broker：设置messageQueue的id
    ...
    public TransactionSendResult sendMessageInTransaction(final Message msg,
            ...
            case SEND_OK: {
                try {
                    ...
                    if (null != localTransactionExecuter) {
                        ...
                        //发送消息成功，回调executeLocalTransaction方法
        ...
        try {
            //根据返回的消息状态，结束事务。但是事务并没有提交，事务提交在事务消息状态回查的时候进行
    ...
    public void endTransaction(
        ...
        //向broker返回事务状态,broker对应的结束事务处理器为：EndTransactionProcessor，对应RequestCode.END_TRANSACTION
