...
public class HashedWheelTimer implements Timer {
     ...
     */
    public HashedWheelTimer(ThreadFactory threadFactory, Long tickDuration, TimeUnit unit, int ticksPerWheel,
                            long maxPendingTimeouts, DefaultMessageStore defaultMessageStore) {
    ...
    private HashedWheelBucket[] createWheel(int ticksPerWheel) {
        ...
        for (int i = 0; i < wheel.length; i++) {
            wheel[i] = new HashedWheelBucket(defaultMessageStore);
        }
        return wheel;
    }
    ...
    public Timeout newTimeout(Task task, long delay, TimeUnit unit) {
        if (task == null) {
        ...
        long deadline = task.getTagsCode() - startTime;
    ...
    private final class Worker implements Runnable {
        ...
        private long waitForNextTick() {
            ...
            for (; ; ) {
                ...
                // }
                //
                /*上面这个方法当sleeptime是小于10的时候会导致sleepTimeMs结果为0，最终的睡眠时间会一直为哦，导致CPU空转，占用过高
                 * 采用+99999 / 1000000 的方法，可以将使用CPU占用过高的问题解决*/
    ...
    private static final class HashedWheelTimeout implements Timeout {
        ...
        HashedWheelTimeout(HashedWheelTimer timer, Task task, long deadline, DefaultMessageStore defaultMessageStore) {
            this.timer = timer;
            this.task = task;
            this.deadline = deadline;
            this.offsetPy = task.getOffsetPy();
            this.sizePy = task.getSizePy();
            this.defaultMessageStore = defaultMessageStore;
        }
        ...
        public void expire() {
            ...
            try {
                MessageExt msgExt =
                        this.defaultMessageStore.lookMessageByOffset(
                                offsetPy, sizePy);
                ...
                if (msgExt != null) {
                    try {
                        ...
                        if (TopicValidator.RMQ_SYS_TRANS_HALF_TOPIC.equals(msgInner.getTopic())) {
                            log.error("[BUG] the real topic of SecondLevel msg is {}, discard the msg. msg={}",
                        ...
                        if (putMessageResult != null
                            ...
                            log.error(
                                    "SecondLevelScheduleMessageService, a message time up, but reput it failed, topic: {} msgId {}",
                                    msgExt.getTopic(), msgExt.getMsgId());

//                            this.bucket.defaultMessageStore.updateOffset(19,
//                                    nextOffset);
                            return;
                        }
                    } catch (Exception e) {
    ...
    private static final class HashedWheelBucket {
        ...
        public HashedWheelBucket(DefaultMessageStore defaultMessageStore) {
            this.defaultMessageStore = defaultMessageStore;
        }
        ...
        public void expireTimeouts(long deadline) {
            ...
            while (timeout != null) {
                ...
                if (timeout.remainingRounds <= 0) {
                    ...
                    System.out.println(timeout.remainingRounds);
                }
                timeout = next;
            }
        }

        // hashwheel[i]节点中双向链表删除节点
