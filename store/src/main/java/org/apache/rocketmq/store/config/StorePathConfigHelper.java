...
public class StorePathConfigHelper {
    ...
    //dorby
    public static String getSecondLevelDelayOffsetStorePath(final String rootDir) {
        return rootDir + File.separator + "config" + File.separator + "secondLevelDelayOffset.json";
    }
